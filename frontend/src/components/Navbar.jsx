import { BarChart3, Bot, Boxes, Handshake, Leaf, ShieldCheck, Trophy } from 'lucide-react'
  ...
  return (
    <nav className="sticky top-0 z-40 border-b border-[#dfe8df]/80 bg-white/88 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3">
        <button className="focus-ring flex items-center gap-3 rounded-md text-left" onClick={() => onChange('dashboard')}>
